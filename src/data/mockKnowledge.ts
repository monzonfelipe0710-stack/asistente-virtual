export type KnowledgeCategory = "Todas" | "Licencias" | "Haberes" | "Ingresos" | "Trámites";

export interface KnowledgeEntry {
  id: number;
  question: string;
  answer: string;
  category: Exclude<KnowledgeCategory, "Todas">;
  active: boolean;
}
...
export const knowledgeBase: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Debe presentar: DNI, últimos 3 recibos de sueldo, certificación de servicios, historia laboral actualizada y formulario de solicitud de jubilación completado.",
    category: "Trámites",
    active: false,
  },
  {
    ...
    answer:
      "Complete el formulario de Solicitud de Permiso por Estudio, adjunte la constancia de inscripción o cursada, y preséntelo en Mesa de Entradas con 5 días hábiles de anticipación.",
    category: "Licencias",
    active: true,
  },
];

export const knowledgeCategories: KnowledgeCategory[] = ["Todas", "Licencias", "Haberes", "Ingresos", "Trámites"];