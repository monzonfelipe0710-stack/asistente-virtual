  ...
  return (
    <div className="relative" ref={ref}>
      <button onClick={() => setOpen(!open)} className="relative p-2 rounded-lg hover:bg-paper/10 transition-colors cursor-pointer bg-transparent border-none">
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 w-4.5 h-4.5 bg-red-500 text-paper text-[9px] font-bold rounded-full flex items-center justify-center ring-2 ring-primary">
            {unreadCount}
          </span>
        )}
      </button>
