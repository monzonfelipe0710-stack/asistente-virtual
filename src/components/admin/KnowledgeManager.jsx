  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
        ...
        <button
          className="px-6 py-3 bg-brand text-paper text-xs font-bold uppercase tracking-wide hover:bg-brand-dark transition-all duration-300 hover:-translate-y-0.5 self-start"
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <button
                    ...
                    className="px-3 py-2 text-[10px] font-bold uppercase tracking-wide text-paper bg-brand cursor-pointer hover:bg-brand-dark transition-all duration-300 hover:-translate-y-0.5"
                  >
                    Editar
                  </button>
                  <button
