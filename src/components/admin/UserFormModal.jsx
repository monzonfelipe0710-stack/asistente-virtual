    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm animate-fade-in p-4" onClick={onClose}>
      <div className="card card-border w-full max-w-md animate-scale-in" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="px-5 py-4 space-y-3">
          <div>
            <label className="text-xs font-medium text-muted mb-1 block">Nombre completo *</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs font-medium text-muted mb-1 block">Rol</label>
          ...
          <div>
            <label className="text-xs font-medium text-muted mb-1 block">Departamento</label>
