export default function ExternalAccess() {
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-[0_18px_45px_-25px_rgba(15,23,42,0.35)]">
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <div>
            <span className="block text-sm font-medium text-slate-800">MiPortal</span>
            <span className="block text-xs text-slate-500">Accedé a tus trámites y recibos</span>
          </div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 rounded-2xl bg-emerald-50 px-4 py-3 no-underline transition hover:-translate-y-0.5 hover:bg-emerald-100"
        >
          ...
          <div>
            ...
            <span className="block text-xs text-slate-500">Contactanos al 3704-000000</span>
          </div>
          <svg className="w-4 h-4 text-slate-400 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
          </svg>
