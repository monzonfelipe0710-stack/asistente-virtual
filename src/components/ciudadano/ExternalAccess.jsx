      ...
      <div className="p-5 space-y-3">
        ...
        >
          ...
          <div className="flex-1">
            <span className="block text-sm font-bold uppercase tracking-wide text-ink">MiPortal</span>
            <span className="block text-xs text-muted mt-0.5">Accedé a tus trámites y recibos</span>
          </div>
        ...
        >
          ...
          <div className="flex-1">
            <span className="block text-sm font-bold uppercase tracking-wide text-ink">WhatsApp</span>
            <span className="block text-xs text-muted mt-0.5">Contactanos al 3704-000000</span>
          </div>
          <svg className="w-4 h-4 text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
          </svg>
