    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4">
      ...
      <div className="space-y-2">
        <a
          ...
          className="flex items-center gap-3 px-4 py-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors no-underline"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 px-4 py-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors no-underline"
        >
