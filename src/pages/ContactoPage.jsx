      ...
      <div className="min-h-screen flex flex-col bg-linear-to-br from-soft to-mist/50">
        ...
        <main className="flex-1 flex items-center justify-center px-4">
          <div className="card card-border p-8 max-w-md w-full text-center animate-scale-in">
            ...
            <p className="text-sm text-muted mb-6 font-medium">Nos pondremos en contacto a la brevedad.</p>
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 animate-page-enter">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 stagger-children">
          <div className="card card-border p-4 text-center">
            ...
            <p className="text-xs text-muted uppercase tracking-wider font-semibold mb-0.5">Email</p>
            <p className="text-sm text-ink font-medium">mesadeayuda@subsechh.formosa.gob.ar</p>
          </div>
          <div className="card card-border p-4 text-center">
            ...
            <p className="text-xs text-muted uppercase tracking-wider font-semibold mb-0.5">Teléfono</p>
            <p className="text-sm text-ink font-medium">0800-555-1234</p>
          </div>
          <div className="card card-border p-4 text-center">
            <div className="w-9 h-9 bg-emerald-50 rounded-xl flex items-center justify-center mx-auto mb-2">
            ...
            <p className="text-xs text-muted uppercase tracking-wider font-semibold mb-0.5">WhatsApp</p>
            <p className="text-sm text-ink font-medium">3704-000000</p>
          </div>
        </div>
      </main>
      <Footer />
